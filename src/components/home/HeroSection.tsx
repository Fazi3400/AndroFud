  ...
  return (
    ...
    >
      ...
      {brand === "androfud" && (
        ...
        >
          <source src="/assets/videos/androfud.mp4" type="video/mp4" />
        </video>
      )}
      {brand === "btmob" && (
        <video
          ...
          className="absolute inset-0 w-full h-full object-cover z-0"
        >
          <source src="/assets/videos/btmob.mp4" type="video/mp4" />
        </video>
      )}
      {brand === "windowstools" && (
        <video
      ...
      <div className="absolute inset-0 overflow-hidden z-2">
        <div
          className={`absolute -top-20 -right-20 w-40 h-40 sm:w-96 sm:h-96 ${brand === "androfud" ? "bg-purple-500" : "bg-cyan-500"} rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse`}
        ></div>
        <div
