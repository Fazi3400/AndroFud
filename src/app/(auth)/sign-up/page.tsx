  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center relative overflow-hidden bg-[#030712]">
      ...
      <div className="relative z-10 w-full max-w-md px-4 space-y-8 pointer-events-auto">
        {/* Logo/Branding */}
        <div className="text-center" style={{ animation: "slideInUp 0.8s cubic-bezier(0.34, 1.56, 0.64, 1)" }}>
          <div className="inline-block mb-8">
            ...
            <div className="h-1 w-16 mx-auto mt-2 bg-gradient-to-r from-[#0099ff] to-[#00f5ff] rounded-full" style={{ animation: "pulse-glow 2s ease-in-out infinite" }}></div>
          </div>
        </div>
        ...
        <div
          ...
          style={{ animation: "slideInUp 0.8s cubic-bezier(0.34, 1.56, 0.64, 1) 0.1s both" }}
        >
          <h1 className="text-5xl md:text-6xl font-black text-white leading-tight" style={{ animation: "textGlow 3s ease-in-out infinite" }}>
            Create Your Account
          </h1>
          <p className="text-[#00f5ff]/80 text-base md:text-lg font-light" style={{ animation: "fadeIn 0.8s ease-out 0.3s both" }}>
        ...
        <div
          className="relative"
          style={{ animation: "slideInUp 0.8s cubic-bezier(0.34, 1.56, 0.64, 1) 0.2s both" }}
        >
          {/* Animated Background Glow */}
          <div className="absolute -inset-0.5 bg-gradient-to-r from-[#0099ff] via-[#00f5ff] to-[#0099ff] rounded-3xl opacity-20 blur-lg animate-pulse" style={{ animation: "pulse-glow 3s ease-in-out infinite" }}></div>
        ...
        {/* Divider */}
        <div className="flex items-center gap-4" style={{ animation: "fadeIn 0.8s ease-out 0.4s both" }}>
        ...
        {/* Footer Links */}
        <div className="space-y-4 pt-4" style={{ animation: "slideInUp 0.8s cubic-bezier(0.34, 1.56, 0.64, 1) 0.5s both" }}>
        ...
        <div
          ...
          style={{ animation: "slideInUp 0.8s cubic-bezier(0.34, 1.56, 0.64, 1) 0.6s both" }}
        >
          <p>By signing up, you agree to our</p>
          <p>
            <Link href="#" className="text-[#00f5ff]/70 hover:text-[#00f5ff] transition-colors">
              Terms of Service
            </Link>
            {" and "}
            <Link href="#" className="text-[#00f5ff]/70 hover:text-[#00f5ff] transition-colors">
        ...
        <div
          ...
          style={{ animation: "slideInUp 0.8s cubic-bezier(0.34, 1.56, 0.64, 1) 0.7s both" }}
        >
