...
export default function DashboardPage() {
  return (
    <>
      <div className="flex-col md:flex bg-black min-h-screen">
          ...
          <Tabs defaultValue="overview" className="space-y-4">
            ...
            <TabsContent value="overview" className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <Card className="bg-[#0d2818] border-2 border-[#0099ff] hover:border-[#d8b4fe] transition-colors">
              ...
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
                <Card className="col-span-4 bg-[#0d2818] border-2 border-[#0099ff] hover:border-[#d8b4fe] transition-colors">
                  <CardHeader>
                    <CardTitle className="text-[#a855f7]">Overview</CardTitle>
                  </CardHeader>
