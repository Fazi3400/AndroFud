...
export const products = pgTable(
  "products",
  {
    ...
    section: varchar("section", { length: 100 }), // "androfud", "btmob", "windows"
    subsection: varchar("subsection", { length: 100 }), // "plans", "versions", "rats"
  },
  (table) => {
    return {
...
// Collections removed - using Sections instead
