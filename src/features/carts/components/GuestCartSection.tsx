        ...
        >
          ...
          <Card className="w-full h-full px-3 col-span-12 md:col-span-3 bg-gradient-to-br from-[#1a3a2e] to-[#0d2818] border border-[#0099ff] border-opacity-30 rounded-xl">
            ...
            <CardContent className="relative overflow-hidden px-3 py-2">
              <p className="text-3xl md:text-lg lg:text-2xl font-bold text-[#a855f7]">{`$ ${subtotal.toFixed(2).toString()}`}</p>
            </CardContent>
...
export const LoadingCartSection = () => (
  ...
  >
    ...
    <div className="w-full h-[180px] px-3 col-span-12 md:col-span-3 border border-[#0099ff] border-opacity-30 bg-gradient-to-br from-[#1a3a2e] to-[#0d2818] p-5 rounded-xl">
      <div className="space-y-3 w-full">
        <Skeleton className="h-6 max-w-xs bg-[#0099ff]" />
        <Skeleton className="h-4 bg-[#0099ff]" />
